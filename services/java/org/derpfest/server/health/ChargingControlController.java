...
public class ChargingControlController extends LineageHealthFeature {
    ...
    private final Uri MODE_URI = Settings.System.getUriFor(
            DerpFestSettings.System.CHARGING_CONTROL_MODE);
    private final Uri LIMIT_URI = Settings.System.getUriFor(
            DerpFestSettings.System.CHARGING_CONTROL_LIMIT);
    private final Uri ENABLED_URI = Settings.System.getUriFor(
            DerpFestSettings.System.CHARGING_CONTROL_ENABLED);
    private final Uri START_TIME_URI = Settings.System.getUriFor(
            DerpFestSettings.System.CHARGING_CONTROL_START_TIME);
    private final Uri TARGET_TIME_URI = Settings.System.getUriFor(
            DerpFestSettings.System.CHARGING_CONTROL_TARGET_TIME);
    ...
    private static final String INTENT_PARTS =
            "com.android.settings.derpfest.health.CHARGING_CONTROL_SETTINGS";
    ...
    public boolean setEnabled(boolean enabled) {
        putBoolean(DerpFestSettings.System.CHARGING_CONTROL_ENABLED, enabled);
        return true;
    }
    ...
    public boolean setStartTime(int time) {
        ...
        putInt(DerpFestSettings.System.CHARGING_CONTROL_START_TIME, time);
        return true;
    }
    ...
    public boolean setTargetTime(int time) {
        ...
        putInt(DerpFestSettings.System.CHARGING_CONTROL_TARGET_TIME, time);
        return true;
    }
    ...
    public boolean setLimit(int limit) {
        ...
        putInt(DerpFestSettings.System.CHARGING_CONTROL_LIMIT, limit);
        return true;
    }
    ...
    private void handleSettingChange() {
        mConfigEnabled = Settings.System.getInt(mContentResolver,
                DerpFestSettings.System.CHARGING_CONTROL_ENABLED, 0)
                != 0;
