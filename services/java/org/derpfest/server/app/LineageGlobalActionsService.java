...
import org.derpfest.app.ILineageGlobalActions;
import org.derpfest.providers.DerpFestSettings;
import org.derpfest.util.PowerMenuConstants;
...
public class LineageGlobalActionsService extends SystemService {
    ...
    private String[] getUserConfig() {
        String savedActions = Settings.Secure.getStringForUser(mContentResolver,
                DerpFestSettings.Secure.POWER_MENU_ACTIONS, UserHandle.USER_CURRENT);
    ...
    private void saveUserConfig() {
        ...
        Settings.Secure.putStringForUser(mContentResolver, DerpFestSettings.Secure.POWER_MENU_ACTIONS, s, UserHandle.USER_CURRENT);
    }
