...
public class LiveDisplayService extends SystemService {
    ...
    private final class ModeObserver extends UserContentObserver {
        ...
        private final Uri MODE_SETTING =
                Settings.System.getUriFor(DerpFestSettings.System.DISPLAY_TEMPERATURE_MODE);
        ...
        int getMode() {
            return getInt(DerpFestSettings.System.DISPLAY_TEMPERATURE_MODE,
                    mConfig.getDefaultMode());
        }

        boolean setMode(int mode) {
            if (mConfig.hasFeature(mode) && mode >= MODE_FIRST && mode <= MODE_LAST) {
                putInt(DerpFestSettings.System.DISPLAY_TEMPERATURE_MODE, mode);
    ...
    private int getSunsetCounter() {
        ...
        return Settings.System.getIntForUser(mContext.getContentResolver(),
                DerpFestSettings.System.LIVE_DISPLAY_HINTED,
                -3,
