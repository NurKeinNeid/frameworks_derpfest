...
import static org.derpfest.hardware.LiveDisplayManager.MODE_OUTDOOR;
...
public class OutdoorModeController extends LiveDisplayFeature {
    ...
    public void onStart() {
        ...
        registerSettings(
                Settings.System.getUriFor(DerpFestSettings.System.DISPLAY_AUTO_OUTDOOR_MODE));
    }
    ...
    boolean setAutomaticOutdoorModeEnabled(boolean enabled) {
        ...
        putBoolean(DerpFestSettings.System.DISPLAY_AUTO_OUTDOOR_MODE, enabled);
        return true;
    }

    boolean isAutomaticOutdoorModeEnabled() {
        return mUseOutdoorMode && (mNightDisplayAvailable ||
                getBoolean(DerpFestSettings.System.DISPLAY_AUTO_OUTDOOR_MODE,
