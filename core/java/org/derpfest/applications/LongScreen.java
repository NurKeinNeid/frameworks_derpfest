...
package org.derpfest.applications;
...
public class LongScreen {
    ...
    public void addApp(String packageName) {
        ...
        Settings.System.putString(mContext.getContentResolver(),
                DerpFestSettings.System.LONG_SCREEN_APPS, String.join(",", mApps));
    }
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    DerpFestSettings.System.LONG_SCREEN_APPS), false, this,
                    UserHandle.USER_ALL);
        ...
        public void update() {
            ...
            String apps = Settings.System.getStringForUser(resolver,
                    DerpFestSettings.System.LONG_SCREEN_APPS,
