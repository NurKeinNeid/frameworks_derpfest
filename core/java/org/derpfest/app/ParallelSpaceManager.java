 ...
 * It requires org.derpfest.Manifest.permission.MANAGE_PARALLEL_SPACES.
 * 
 * @hide
 */
public final class ParallelSpaceManager {
    ...
    private ParallelSpaceManager() {
        mParallelSpaceManager = IParallelSpaceManager.Stub.asInterface(
                ServiceManager.getService(DerpFestContextConstants.PARALLEL_SERVICE));
